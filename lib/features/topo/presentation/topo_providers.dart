...
final sectorPhotosRepositoryProvider = Provider<SectorPhotosRepository?>((
  ref,
) {
...
final sectorPhotosProvider =
    FutureProvider.family<List<SectorPhoto>?, String>((ref, sectorId) async {
